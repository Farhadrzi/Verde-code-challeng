...
class GetAllAppointmentListTest extends TestCase
{
    use RefreshDatabase;
    private $authToken;
     ...
     * @return void
     */
    public function test_get_all_appointment_list()
    {
        $response = $this->get('/api/appointment/list/all',['Authorization'=>'Bearer '.$this->authToken]);
