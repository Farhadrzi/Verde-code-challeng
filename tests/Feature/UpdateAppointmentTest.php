...
class UpdateAppointmentTest extends TestCase
{
     ...
     * @return void
     */
    public function test_update_appointment_data()
    {
        $response = $this->put('/api/appointment/update',["appointmentId"=>1,"appointmentData"=>["contact"=>["name"=>"test"]]],['Authorization'=>'Bearer '.$this->authToken]);
